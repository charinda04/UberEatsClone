...
export type RestaurantDetailNavigationProp = StackNavigationProp<ParamListBase, 'RESTAURANT_DETAIL'>;
export type RestaurantDetailRouteProp = RouteProp<ParamListBase, 'RESTAURANT_DETAIL'>;
...
const RestaurantDetail: React.FC<Props> = props => {
